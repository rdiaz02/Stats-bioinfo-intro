...
{\footnotesize This work is Copyright, \copyright, 2014, 2015, 2016, 2017,
  Ramon Diaz-Uriarte, and is
...
<<label='bm13-escenarios',include=FALSE,echo=FALSE,fig.width=8,fig.height=6>>=
...
\includegraphics[%
    width=11.0cm,
    keepaspectratio]{./figure/bm13-escenarios-1}
\end{textblock*}
\end{frame}
...
<<label='bm13-nonpaired',include=FALSE,echo=FALSE,fig.width=8,fig.height=6>>=
par(mfrow = c(1, 1))
...
@ 
<<label='bm13-paired',include=FALSE,echo=FALSE,fig.width=8,fig.height=6>>=
stripchart(list(x1, x2), vertical = TRUE, pch = 19, axes = FALSE, ylab = "MYC")
box()
axis(2)
axis(1, at= c(1, 2), labels = c("Non-tumor", "Tumor")) 
...
\includegraphics[%
    width=11.0cm,
    keepaspectratio]{./figure/bm13-nonpaired-1}
\end{textblock*}
\end{frame}
...
\includegraphics[%
    width=11.0cm,
    keepaspectratio]{./figure/bm13-paired-1}
\end{textblock*}
\end{frame}
