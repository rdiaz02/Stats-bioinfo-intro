...
\begin{frame}
  \frametitle{Regularization, ridge, the lasso, \ldots}
  \begin{itemize}
  \item As it says. What and why?
  \end{itemize}
\end{frame}
...
\begin{frame}
  \frametitle{Wisdom of crowds}
  \begin{itemize}
  \item Aggregating predictions from different methods; mixtures of experts.
  \item We saw a similar idea with random forests.
  \item See Tarca et al. paper.
  \end{itemize}
\end{frame}

\begin{frame}
  \frametitle{And boosting?}
  \begin{itemize}
    \item \ldots
  \end{itemize}
\end{frame}
...
\begin{frame}
  \frametitle{A beautiful and insightful exposition of major themes}
  \begin{itemize}
  \item Efron and Hastie, 2016, ``Computer age statistical inference''
  \end{itemize}
\end{frame}
