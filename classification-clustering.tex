...
\vspace*{15pt}
You'll do an exercise with \Burl{http://tnasas.iib.uam.es}
\end{frame}
...
\begin{frame}
  ...
  \item \textbf{Parametric survival models}: model the distribution of
    time to death.
  \item \textbf{Log-rank test}: a way of comparing survival curves. \Burl{http://signs.iib.uam.es/Examples/CommentedExample/results.html}
  \end{itemize}
\end{frame}
